...
<html lang="en">
   	...
   	<body>
    	<div class="container">
		    ...
		    <div class="row">
		    	<h4 class="text-center bold">OFFICIAL RECEIPT</h4>
		    </div>
		    <br />
		    <div class="row">
		    	<div class="col-xs-7">
		    		Received From : {{ $submission->user->name }}
		    		<br />
		    		<br />
				...
				<div class="col-xs-12">
					<table class="table table-bordered table-condensed">
						...
						<tr>
							...
							<td>{{ number_format($submission->amount_to_invoice_landlord + $submission->gst_by_landlord_vendor,2) }}</td>
						</tr>
					</table>
				</div>
		    </div>
		    ...
		    <div class="row">
		    	<div class="col-xs-12">
		    		<p>This receipt is subject clearance of the cheque/ transfer payment/ cash deposit credited into the account of PROPLENX REALTY. </p>
					<br />
