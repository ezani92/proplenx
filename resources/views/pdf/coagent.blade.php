...
<html lang="en">
   	...
   	<body>
    	<div class="container">
		    ...
		    <div class="row">
		    	<div class="col-xs-7">
		    		To: {{ $submission->coagent_company_name_2 }}<br />
		    		{{ $submission->coagent_company_email_2 }}<br />
		    	</div>
		    	<div class="col-xs-5">
		    ...
		    <div class="row">
				<div class="col-xs-12">
					<table class="table table-bordered table-condensed">
						...
						<tr>
							<td>1.</td>
							<td>Co-Agency Fees</td>
							<td>{{ $submission->proplenx_portion_value_2 }}</td>
						</tr>
						<tr>
							<td>2.</td>
							<td>Goods & Services Tax (if any)</td>
							<td>{{ $submission->coagent_company_gst_by_landlord_2 }}</td>
						</tr>
						<tr>
							<td></td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td>{{ $submission->coagent_company_total_amount_to_invoice_2 }}</td>
						</tr>
					</table>
				</div>
		    </div>
